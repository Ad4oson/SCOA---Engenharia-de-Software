...
import academico.view.Professor.FrequenciaTableModel;
 ...
 * @author Windows 11
 */
public class ConsultarFrequenciaAluno extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ConsultarFrequenciaAluno.class.getName());

    /**
     * Creates new form ConsultarFrequenciaAluno
     */
    public ConsultarFrequenciaAluno() {
        initComponents();
        frequenciaPrint();
        System.out.println("USUARIO LOGIN, FREQUENCIA ALUNO: " + Sessao.getUsuarioLogado().getLogin());
    }
    
    
    public void frequenciaPrint(){
        ...
        EntityManager em = JPAUtil.getEntityManager();
            ...
            try { 
                ...
                List<FrequenciaAluno> dados = aluno.consultarFrequencia(em);

                jTable1.setModel(new FrequenciaTableModelAluno(dados));
            } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConsultarFrequenciaAluno().setVisible(true));
    }
