 ...
 * @author Windows 11
 */
public class RegistrarCursoSecretario extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RegistrarCursoSecretario.class.getName());

    /**
     * Creates new form MatricularAlunoSecretario
     */
    public RegistrarCursoSecretario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        statusBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Aguardo", "Andamento" }));
    ...
    private void salvarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarButtonActionPerformed
        ...
        try {
            ...
            try {
                ...
                for (int r=0; r<disciplinaTable.getRowCount(); r++){
                    ...
                    if (disciplinaTable.getValueAt(r,0) != null) {
                        ...
                        disciplinaTemp = em.createQuery(jpqlDisciplina,Disciplina.class).setParameter("DisciplinaNome",disciplinaNome).getSingleResult();
            ...
            try {
                ...
                for (int r=0; r<matriculaTable.getRowCount(); r++){
                    ...
                    if (matriculaTable.getValueAt(r, 0) != null) {
                        ...
                        alunoTemp = em.createQuery(jpqlAluno,Aluno.class).setParameter("matricula",matricula).getSingleResult();

                        listaAluno.add(alunoTemp);
           ...
           secretario.cadastrarCurso(em, nomeField.getText().toUpperCase(), mensalidadeField.getText(), turno, cargaHoraria,
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RegistrarCursoSecretario().setVisible(true));
    }
