...
public class AtualizarAlunoSecretario extends javax.swing.JFrame {
     ...
     */
    public AtualizarAlunoSecretario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        alunoBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pressionar Filtrar", " " }));
        alunoBox.addActionListener(this::alunoActionEvent);
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(alunoBox, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        if (!pesquisaField.getText().contentEquals("")) {
            try {
                String jpqlAluno = """
                                   ...
                                   ORDER BY a.nome
                                   """;
                List<Aluno> alunos = em.createQuery(jpqlAluno,Aluno.class).setParameter("cursoNome", pesquisaField.getText().toUpperCase()).getResultList();
                
                for (Aluno a : alunos){
                    alunoBox.addItem(a.getNome());
                }
    ...
    private void alunoActionEvent(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alunoActionEvent
        // TODO add your handling code here:
        EntityManager em = JPAUtil.getEntityManager();
        ...
        Aluno a = em.createQuery(jpqlAluno, Aluno.class).setParameter("nomeAluno",alunoSelecionado).getSingleResult();
                
        nomeField1.setText(a.getNome());
        cpfField1.setText(a.getCpf());
        rgField1.setText(a.getRg());
        enderecoField1.setText(a.getEndereco());
        nascimentoField1.setText(String.valueOf(a.getNascimento()));
        poloField1.setText(a.getPolo());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new AtualizarAlunoSecretario().setVisible(true));
    }
