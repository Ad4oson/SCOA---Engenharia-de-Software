 ...
 * @author Windows 11
 */
public class InicialCoordenador extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(InicialCoordenador.class.getName());

    /**
     * Creates new form InicialCoordenador
     */
    public InicialCoordenador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        alunoCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Registrar Disciplina", "Atualizar Disciplina", "Consultar Disciplina" }));
    ...
    private void alunoComborequisicaoComboEvent(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alunoComborequisicaoComboEvent
        ...
        if(alunoCombo.getSelectedIndex() == 0){
            ...
            new AtualizarDisciplinaCoordenador().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new InicialCoordenador().setVisible(true));
    }
